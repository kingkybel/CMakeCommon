...
function(dkyb_register_dependency NAME)
    set(options)
    set(oneValueArgs GIT_REPOSITORY ARCHIVE_URL_TEMPLATE LATEST_ASSET_URL LATEST_GIT_TAG SOURCE_SUBDIR VERSION_TRANSFORM GIT_TAG_TEMPLATE)
    ...
    if(DKYB_DEP_REG_GIT_TAG_TEMPLATE)
        dkyb_dependency_register_argument(${NAME} GIT_TAG_TEMPLATE "${DKYB_DEP_REG_GIT_TAG_TEMPLATE}")
    endif()
endfunction()
...
function(dkyb_build_and_cache NAME VERSION)
    ...
    if(_resolved_version STREQUAL "latest")
        ...
        dkyb_dependency_get_argument(${NAME} GIT_TAG_TEMPLATE _git_tag_template)
        if(_git_tag_template)
            string(REPLACE "<version>" "${_resolved_version}" _git_tag "${_git_tag_template}")
        else()
